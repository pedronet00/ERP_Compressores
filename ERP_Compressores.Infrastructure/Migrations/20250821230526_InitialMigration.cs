        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Empresas_Guid", x => x.Guid);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            // Criar índice para busca por EmpresaId
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CategoriaProdutos_Empresas_EmpresaId",
                        column: x => x.EmpresaId,
                        principalTable: "Empresas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Clientes_Guid", x => x.Guid);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DescontoPercentual = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValorOriginal = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DescontoPercentual = table.Column<int>(type: "int", nullable: false),
                    ValorTotal = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Descricao = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Status = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VisitasTecnicas_Clientes_ClienteId",
                        column: x => x.ClienteId,
                        principalTable: "Clientes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VisitasTecnicas_Empresas_EmpresaId",
                        column: x => x.EmpresaId,
                        principalTable: "Empresas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoriaProdutos_EmpresaId",
                table: "CategoriaProdutos",
                column: "EmpresaId");

            migrationBuilder.CreateIndex(
                name: "IX_CategoriaProdutos_Guid",
                table: "CategoriaProdutos",
                column: "Guid",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Fornecedores_Guid",
                table: "Fornecedores",
                column: "Guid",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ItensOrcamento_Guid",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VisitasTecnicas_ClienteId",
                table: "VisitasTecnicas",
                column: "ClienteId");

            migrationBuilder.CreateIndex(
                name: "IX_VisitasTecnicas_EmpresaId",
                table: "VisitasTecnicas",
                column: "EmpresaId");
        }
